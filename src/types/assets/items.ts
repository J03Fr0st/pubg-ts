...
// Last updated: 2025-07-28T14:39:41.300Z
...
export type OtherItemId = 'Helmet_Repair_Kit_C' | 'InstantRevivalKit_C' | 'Item_BulletproofShield_C' | 'Item_Chimera_Key_C' | 'Item_DihorOtok_Key_C' | 'Item_EmergencyPickup_C' | 'Item_Ghillie_01_C' | 'Item_Ghillie_02_C' | 'Item_Ghillie_03_C' | 'Item_Ghillie_04_C' | 'Item_Ghillie_05_C' | 'Item_Ghillie_06_C' | 'Item_Ghillie_07_C' | 'Item_Head_E_01_Lv1_C' | 'Item_Head_E_02_Lv1_C' | 'Item_Head_F_01_Lv2_C' | 'Item_Head_F_02_Lv2_C' | 'Item_Head_G_01_Lv3_C' | 'Item_Heaven_Key_C' | 'Item_JerryCan_C' | 'Item_Mountainbike_C' | 'Item_Secuity_KeyCard_C' | 'Item_Special_Ascender_C' | 'Item_Special_Ascender_NoChicken_C' | 'Item_Tiger_Key_C' | 'Item_Tiger_SelfRevive_C' | 'SP6_EventItem_DVD_01_C' | 'SP6_EventItem_DVD_02_C' | 'SP6_EventItem_DVD_03_C' | 'Vehicle_Repair_Kit_C' | 'Vest_Repair_Kit_C' | 'WarModeStartParachutePack_C';

export type AmmunitionItemId = 'Item_Ammo_12GuageSlug_C' | 'Item_Ammo_12Guage_C' | 'Item_Ammo_300Magnum_C' | 'Item_Ammo_40mm_C' | 'Item_Ammo_45ACP_C' | 'Item_Ammo_556mm_C' | 'Item_Ammo_57mm_C' | 'Item_Ammo_762mm_C' | 'Item_Ammo_9mm_C' | 'Item_Ammo_Bolt_C' | 'Item_Ammo_Flare_C' | 'Item_Ammo_Mortar_C';

export type EquipmentItemId = 'Item_Armor_C_01_Lv3_C' | 'Item_Armor_D_01_Lv2_C' | 'Item_Armor_E_01_Lv1_C' | 'Item_Back_B_01_StartParachutePack_C' | 'Item_Back_B_08_Lv3_C' | 'Item_Back_BackupParachute_C' | 'Item_Back_BlueBlocker' | 'Item_Back_C_01_Lv3_C' | 'Item_Back_C_02_Lv3_C' | 'Item_Back_E_01_Lv1_C' | 'Item_Back_E_02_Lv1_C' | 'Item_Back_F_01_Lv2_C' | 'Item_Back_F_02_Lv2_C' | 'Item_Special_BackupParachute_C';

export type WeaponItemId = 'Item_Attach_Weapon_Lower_AngledForeGrip_C' | 'Item_Attach_Weapon_Lower_Foregrip_C' | 'Item_Attach_Weapon_Lower_HalfGrip_C' | 'Item_Attach_Weapon_Lower_LaserPointer_C' | 'Item_Attach_Weapon_Lower_LightweightForeGrip_C' | 'Item_Attach_Weapon_Lower_QuickDraw_Large_Crossbow_C' | 'Item_Attach_Weapon_Lower_ThumbGrip_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Large_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Medium_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Small_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_SniperRifle_C' | 'Item_Attach_Weapon_Magazine_Extended_Large_C' | 'Item_Attach_Weapon_Magazine_Extended_Medium_C' | 'Item_Attach_Weapon_Magazine_Extended_Small_C' | 'Item_Attach_Weapon_Magazine_Extended_SniperRifle_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Large_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Medium_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Small_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Choke_C' | 'Item_Attach_Weapon_Muzzle_Compensator_Large_C' | 'Item_Attach_Weapon_Muzzle_Compensator_Medium_C' | 'Item_Attach_Weapon_Muzzle_Compensator_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Duckbill_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_Large_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_Medium_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Large_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Medium_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Small_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_SniperRifle_C' | 'Item_Attach_Weapon_SideRail_DotSight_RMR_C' | 'Item_Attach_Weapon_Stock_AR_Composite_C' | 'Item_Attach_Weapon_Stock_AR_HeavyStock_C' | 'Item_Attach_Weapon_Stock_Shotgun_BulletLoops_C' | 'Item_Attach_Weapon_Stock_SniperRifle_BulletLoops_C' | 'Item_Attach_Weapon_Stock_SniperRifle_CheekPad_C' | 'Item_Attach_Weapon_Stock_UZI_C' | 'Item_Attach_Weapon_Upper_ACOG_01_C' | 'Item_Attach_Weapon_Upper_Aimpoint_C' | 'Item_Attach_Weapon_Upper_CQBSS_C' | 'Item_Attach_Weapon_Upper_DotSight_01_C' | 'Item_Attach_Weapon_Upper_Holosight_C' | 'Item_Attach_Weapon_Upper_PM2_01_C' | 'Item_Attach_Weapon_Upper_Scope3x_C' | 'Item_Attach_Weapon_Upper_Scope6x_C' | 'Item_Attach_Weapon_Upper_Thermal_C' | 'Item_Weapon_ACE32_C' | 'Item_Weapon_AK47_C' | 'Item_Weapon_AUG_C' | 'Item_Weapon_AWM_C' | 'Item_Weapon_Apple_C' | 'Item_Weapon_Berreta686_C' | 'Item_Weapon_BerylM762_C' | 'Item_Weapon_BizonPP19_C' | 'Item_Weapon_BlueChipDetector_C' | 'Item_Weapon_BluezoneGrenade_C' | 'Item_Weapon_C4_C' | 'Item_Weapon_Cowbar_C' | 'Item_Weapon_Crossbow_C' | 'Item_Weapon_DP12_C' | 'Item_Weapon_DP28_C' | 'Item_Weapon_DecoyGrenade_C' | 'Item_Weapon_DesertEagle_C' | 'Item_Weapon_Dragunov_C' | 'Item_Weapon_Drone_C' | 'Item_Weapon_Duncans_M416_C' | 'Item_Weapon_FNFal_C' | 'Item_Weapon_FlareGun_C' | 'Item_Weapon_FlashBang_C' | 'Item_Weapon_G18_C' | 'Item_Weapon_G36C_C' | 'Item_Weapon_Grenade_C' | 'Item_Weapon_Grenade_Warmode_C' | 'Item_Weapon_Groza_C' | 'Item_Weapon_HK416_C' | 'Item_Weapon_JS9_C' | 'Item_Weapon_K2_C' | 'Item_Weapon_Kar98k_C' | 'Item_Weapon_L6_C' | 'Item_Weapon_M16A4_C' | 'Item_Weapon_M1911_C' | 'Item_Weapon_M249_C' | 'Item_Weapon_M24_C' | 'Item_Weapon_M79_C' | 'Item_Weapon_M9_C' | 'Item_Weapon_MG3_C' | 'Item_Weapon_MP5K_C' | 'Item_Weapon_MP9_C' | 'Item_Weapon_Machete_C' | 'Item_Weapon_Mads_QBU88_C' | 'Item_Weapon_Mini14_C' | 'Item_Weapon_Mk12_C' | 'Item_Weapon_Mk14_C' | 'Item_Weapon_Mk47Mutant_C' | 'Item_Weapon_Molotov_C' | 'Item_Weapon_Mortar_C' | 'Item_Weapon_Mosin_C' | 'Item_Weapon_NagantM1895_C' | 'Item_Weapon_OriginS12_C' | 'Item_Weapon_P90_C' | 'Item_Weapon_Pan_C' | 'Item_Weapon_PanzerFaust100M_C' | 'Item_Weapon_QBU88_C' | 'Item_Weapon_QBZ95_C' | 'Item_Weapon_Rhino_C' | 'Item_Weapon_Rock_C' | 'Item_Weapon_SCAR-L_C' | 'Item_Weapon_SKS_C' | 'Item_Weapon_Saiga12_C' | 'Item_Weapon_Sawnoff_C' | 'Item_Weapon_Sickle_C' | 'Item_Weapon_SmokeBomb_C' | 'Item_Weapon_Snowball_C' | 'Item_Weapon_SpikeTrap_C' | 'Item_Weapon_Spotter_Scope_C' | 'Item_Weapon_StickyGrenade_C' | 'Item_Weapon_StunGun_C' | 'Item_Weapon_TacPack_C' | 'Item_Weapon_Thompson_C' | 'Item_Weapon_TraumaBag_C' | 'Item_Weapon_UMP_C' | 'Item_Weapon_UZI_C' | 'Item_Weapon_VSS_C' | 'Item_Weapon_Vector_C' | 'Item_Weapon_Win1894_C' | 'Item_Weapon_Winchester_C' | 'Item_Weapon_vz61Skorpion_C';

export type ConsumableItemId = 'Item_Boost_AdrenalineSyringe_C' | 'Item_Boost_EnergyDrink_C' | 'Item_Boost_PainKiller_C' | 'Item_Heal_Bandage_C' | 'Item_Heal_FirstAid_C' | 'Item_Heal_MedKit_C';

export type ItemId = 'Helmet_Repair_Kit_C' | 'InstantRevivalKit_C' | 'Item_Ammo_12GuageSlug_C' | 'Item_Ammo_12Guage_C' | 'Item_Ammo_300Magnum_C' | 'Item_Ammo_40mm_C' | 'Item_Ammo_45ACP_C' | 'Item_Ammo_556mm_C' | 'Item_Ammo_57mm_C' | 'Item_Ammo_762mm_C' | 'Item_Ammo_9mm_C' | 'Item_Ammo_Bolt_C' | 'Item_Ammo_Flare_C' | 'Item_Ammo_Mortar_C' | 'Item_Armor_C_01_Lv3_C' | 'Item_Armor_D_01_Lv2_C' | 'Item_Armor_E_01_Lv1_C' | 'Item_Attach_Weapon_Lower_AngledForeGrip_C' | 'Item_Attach_Weapon_Lower_Foregrip_C' | 'Item_Attach_Weapon_Lower_HalfGrip_C' | 'Item_Attach_Weapon_Lower_LaserPointer_C' | 'Item_Attach_Weapon_Lower_LightweightForeGrip_C' | 'Item_Attach_Weapon_Lower_QuickDraw_Large_Crossbow_C' | 'Item_Attach_Weapon_Lower_ThumbGrip_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Large_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Medium_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Small_C' | 'Item_Attach_Weapon_Magazine_ExtendedQuickDraw_SniperRifle_C' | 'Item_Attach_Weapon_Magazine_Extended_Large_C' | 'Item_Attach_Weapon_Magazine_Extended_Medium_C' | 'Item_Attach_Weapon_Magazine_Extended_Small_C' | 'Item_Attach_Weapon_Magazine_Extended_SniperRifle_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Large_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Medium_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_Small_C' | 'Item_Attach_Weapon_Magazine_QuickDraw_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Choke_C' | 'Item_Attach_Weapon_Muzzle_Compensator_Large_C' | 'Item_Attach_Weapon_Muzzle_Compensator_Medium_C' | 'Item_Attach_Weapon_Muzzle_Compensator_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Duckbill_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_Large_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_Medium_C' | 'Item_Attach_Weapon_Muzzle_FlashHider_SniperRifle_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Large_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Medium_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_Small_C' | 'Item_Attach_Weapon_Muzzle_Suppressor_SniperRifle_C' | 'Item_Attach_Weapon_SideRail_DotSight_RMR_C' | 'Item_Attach_Weapon_Stock_AR_Composite_C' | 'Item_Attach_Weapon_Stock_AR_HeavyStock_C' | 'Item_Attach_Weapon_Stock_Shotgun_BulletLoops_C' | 'Item_Attach_Weapon_Stock_SniperRifle_BulletLoops_C' | 'Item_Attach_Weapon_Stock_SniperRifle_CheekPad_C' | 'Item_Attach_Weapon_Stock_UZI_C' | 'Item_Attach_Weapon_Upper_ACOG_01_C' | 'Item_Attach_Weapon_Upper_Aimpoint_C' | 'Item_Attach_Weapon_Upper_CQBSS_C' | 'Item_Attach_Weapon_Upper_DotSight_01_C' | 'Item_Attach_Weapon_Upper_Holosight_C' | 'Item_Attach_Weapon_Upper_PM2_01_C' | 'Item_Attach_Weapon_Upper_Scope3x_C' | 'Item_Attach_Weapon_Upper_Scope6x_C' | 'Item_Attach_Weapon_Upper_Thermal_C' | 'Item_Back_B_01_StartParachutePack_C' | 'Item_Back_B_08_Lv3_C' | 'Item_Back_BackupParachute_C' | 'Item_Back_BlueBlocker' | 'Item_Back_C_01_Lv3_C' | 'Item_Back_C_02_Lv3_C' | 'Item_Back_E_01_Lv1_C' | 'Item_Back_E_02_Lv1_C' | 'Item_Back_F_01_Lv2_C' | 'Item_Back_F_02_Lv2_C' | 'Item_Boost_AdrenalineSyringe_C' | 'Item_Boost_EnergyDrink_C' | 'Item_Boost_PainKiller_C' | 'Item_BulletproofShield_C' | 'Item_Chimera_Key_C' | 'Item_DihorOtok_Key_C' | 'Item_EmergencyPickup_C' | 'Item_Ghillie_01_C' | 'Item_Ghillie_02_C' | 'Item_Ghillie_03_C' | 'Item_Ghillie_04_C' | 'Item_Ghillie_05_C' | 'Item_Ghillie_06_C' | 'Item_Ghillie_07_C' | 'Item_Head_E_01_Lv1_C' | 'Item_Head_E_02_Lv1_C' | 'Item_Head_F_01_Lv2_C' | 'Item_Head_F_02_Lv2_C' | 'Item_Head_G_01_Lv3_C' | 'Item_Heal_Bandage_C' | 'Item_Heal_FirstAid_C' | 'Item_Heal_MedKit_C' | 'Item_Heaven_Key_C' | 'Item_JerryCan_C' | 'Item_Mountainbike_C' | 'Item_Secuity_KeyCard_C' | 'Item_Special_Ascender_C' | 'Item_Special_Ascender_NoChicken_C' | 'Item_Special_BackupParachute_C' | 'Item_Tiger_Key_C' | 'Item_Tiger_SelfRevive_C' | 'Item_Weapon_ACE32_C' | 'Item_Weapon_AK47_C' | 'Item_Weapon_AUG_C' | 'Item_Weapon_AWM_C' | 'Item_Weapon_Apple_C' | 'Item_Weapon_Berreta686_C' | 'Item_Weapon_BerylM762_C' | 'Item_Weapon_BizonPP19_C' | 'Item_Weapon_BlueChipDetector_C' | 'Item_Weapon_BluezoneGrenade_C' | 'Item_Weapon_C4_C' | 'Item_Weapon_Cowbar_C' | 'Item_Weapon_Crossbow_C' | 'Item_Weapon_DP12_C' | 'Item_Weapon_DP28_C' | 'Item_Weapon_DecoyGrenade_C' | 'Item_Weapon_DesertEagle_C' | 'Item_Weapon_Dragunov_C' | 'Item_Weapon_Drone_C' | 'Item_Weapon_Duncans_M416_C' | 'Item_Weapon_FNFal_C' | 'Item_Weapon_FlareGun_C' | 'Item_Weapon_FlashBang_C' | 'Item_Weapon_G18_C' | 'Item_Weapon_G36C_C' | 'Item_Weapon_Grenade_C' | 'Item_Weapon_Grenade_Warmode_C' | 'Item_Weapon_Groza_C' | 'Item_Weapon_HK416_C' | 'Item_Weapon_JS9_C' | 'Item_Weapon_K2_C' | 'Item_Weapon_Kar98k_C' | 'Item_Weapon_L6_C' | 'Item_Weapon_M16A4_C' | 'Item_Weapon_M1911_C' | 'Item_Weapon_M249_C' | 'Item_Weapon_M24_C' | 'Item_Weapon_M79_C' | 'Item_Weapon_M9_C' | 'Item_Weapon_MG3_C' | 'Item_Weapon_MP5K_C' | 'Item_Weapon_MP9_C' | 'Item_Weapon_Machete_C' | 'Item_Weapon_Mads_QBU88_C' | 'Item_Weapon_Mini14_C' | 'Item_Weapon_Mk12_C' | 'Item_Weapon_Mk14_C' | 'Item_Weapon_Mk47Mutant_C' | 'Item_Weapon_Molotov_C' | 'Item_Weapon_Mortar_C' | 'Item_Weapon_Mosin_C' | 'Item_Weapon_NagantM1895_C' | 'Item_Weapon_OriginS12_C' | 'Item_Weapon_P90_C' | 'Item_Weapon_Pan_C' | 'Item_Weapon_PanzerFaust100M_C' | 'Item_Weapon_QBU88_C' | 'Item_Weapon_QBZ95_C' | 'Item_Weapon_Rhino_C' | 'Item_Weapon_Rock_C' | 'Item_Weapon_SCAR-L_C' | 'Item_Weapon_SKS_C' | 'Item_Weapon_Saiga12_C' | 'Item_Weapon_Sawnoff_C' | 'Item_Weapon_Sickle_C' | 'Item_Weapon_SmokeBomb_C' | 'Item_Weapon_Snowball_C' | 'Item_Weapon_SpikeTrap_C' | 'Item_Weapon_Spotter_Scope_C' | 'Item_Weapon_StickyGrenade_C' | 'Item_Weapon_StunGun_C' | 'Item_Weapon_TacPack_C' | 'Item_Weapon_Thompson_C' | 'Item_Weapon_TraumaBag_C' | 'Item_Weapon_UMP_C' | 'Item_Weapon_UZI_C' | 'Item_Weapon_VSS_C' | 'Item_Weapon_Vector_C' | 'Item_Weapon_Win1894_C' | 'Item_Weapon_Winchester_C' | 'Item_Weapon_vz61Skorpion_C' | 'SP6_EventItem_DVD_01_C' | 'SP6_EventItem_DVD_02_C' | 'SP6_EventItem_DVD_03_C' | 'Vehicle_Repair_Kit_C' | 'Vest_Repair_Kit_C' | 'WarModeStartParachutePack_C';
