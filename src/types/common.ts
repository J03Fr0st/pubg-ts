...
export type Shard = 
  ...
  | 'stadia-as' | 'stadia-eu' | 'stadia-na' | 'stadia-oc'
  | 'console';

export type GameMode = 
  | 'solo' | 'duo' | 'squad' | 'solo-fpp' | 'duo-fpp' | 'squad-fpp'
  | 'ranked-solo' | 'ranked-duo' | 'ranked-squad' | 'ranked-solo-fpp' | 'ranked-duo-fpp' | 'ranked-squad-fpp'
  | 'normal-solo' | 'normal-duo' | 'normal-squad' | 'normal-solo-fpp' | 'normal-duo-fpp' | 'normal-squad-fpp'
  | 'competitive' | 'esports';

export type MapName = 
  | 'Erangel_Main' | 'Desert_Main' | 'Savage_Main' | 'DihorOtok_Main' | 'Range_Main' | 'Baltic_Main' | 'Summerland_Main'
  | 'Chimera_Main' | 'Heaven_Main' | 'Kiki_Main' | 'Tiger_Main' | 'Neon_Main' | 'Rondo_Main' | 'Taego_Main';