...
- Tests mirror source responsibilities in `tests/unit/`, with service tests using mocked HTTP clients and infrastructure tests for cache/rate limiter/errors/assets. Integration tests exist in `tests/integration/` and may touch real PUBG API scenarios.
