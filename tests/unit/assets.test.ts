...
describe('AssetManager', () => {
  ...
  describe('Season Management', () => {
    it('should get season information by ID', async () => {
      const seasonInfo = await assetManager.getSeasonInfo('division.bro.official.2018-01');
    ...
    it('should return null for non-existent season', async () => {
      const seasonInfo = await assetManager.getSeasonInfo('non-existent-season');
      expect(seasonInfo).toBeNull();
    });
  });
